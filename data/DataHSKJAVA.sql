...
INSERT INTO [dbo].[NhanVien] ([MaNV], [TenNV], [GioiTinh], [Tuoi], [DiaChi], [SoDienThoai], [Email], [HinhAnh], [CaLamViec], [ViTri]) VALUES 
(N'NV1', N'Lê Thành Danh', 0, 20, N'Quận 1, TP.HCM', N'0912345678', N'danhlth@qlbh.com', N'img/avatar/nv1.jpg', N'CA_SANG', N'NHAN_VIEN'),
(N'NV2', N'Lê Thành Đạt', 0, 20, N'Quận 3, TP.HCM', N'0923456789', N'datlth@qlbh.com', N'img/avatar/nv2.jpg', N'CA_SANG', N'NHAN_VIEN'),
(N'NV3', N'Phùng Tùng Lâm', 0, 20, N'Bình Thạnh, TP.HCM', N'0934567890', N'lampt@qlbh.com', N'img/avatar/nv3.jpg', N'CA_CHIEU', N'NHAN_VIEN'),
(N'NV4', N'Trần Phúc An', 0, 20, N'Gò Vấp, TP.HCM', N'0945678901', N'antph@qlbh.com', N'img/avatar/nv4.jpg', N'CA_SANG', N'NHAN_VIEN'),
(N'NV5', N'Hoàng Minh Trí', 0, 26, N'Thủ Đức, TP.HCM', N'0956789012', N'vip888f2@qlbh.com', N'img/avatar/user.png', N'CA_TOI', N'NHAN_VIEN'),
(N'NV6', N'Đặng Minh Khôi', 0, 23, N'Quận 10, TP.HCM', N'0967890123', N'khoidm@qlbh.com', N'img/avatar/user.png', N'CA_CHIEU', N'NHAN_VIEN'),
(N'NV7', N'Bùi Tuyết Nhi', 1, 25, N'Quận 7, TP.HCM', N'0978901234', N'nhibt@qlbh.com', N'img/avatar/user.png', N'CA_SANG', N'NHAN_VIEN'),
(N'NV8', N'Võ Hoàng Nam', 0, 29, N'Gò Vấp, TP.HCM', N'0989012345', N'namvh@qlbh.com', N'img/avatar/user.png', N'CA_CHIEU', N'NHAN_VIEN'),
(N'NV9', N'Đỗ Kim Chi', 1, 27, N'Hóc Môn, TP.HCM', N'0990123456', N'chidk@qlbh.com', N'img/avatar/user.png', N'CA_TOI', N'NHAN_VIEN'),
(N'NV10', N'Lý Thanh Tùng', 0, 31, N'Quận 12, TP.HCM', N'0901234567', N'tunglt@qlbh.com', N'img/avatar/user.png', N'CA_SANG', N'NHAN_VIEN');
GO
